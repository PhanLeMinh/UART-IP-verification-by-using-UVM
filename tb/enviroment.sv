class enviroment extends uvm_env;
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        if(!uvm_config_db#(virtual uart_configuration)::get(this,"","uart_cfg",uart_cfg))
            `uvm_fatal(get_type_name(),"Failed to get uart_cfg from uvm_config_db")

        ahb_agt = ahb_agent::type_id::create("ahb_agt");
        uart_agt = uart_agent::type_id::create("uart_agt");
        ...
        uvm_config_db#(virtual uart_if)::set(this,"uart_agent","uart_vif",uart_vif);
        uvm_config_db#(virtual uart_configuration)::set(this,"uart_agent","uart_cfg",uart_cfg);
